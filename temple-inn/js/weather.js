const apiURL = 'https://api.openweathermap.org/data/2.5/onecall?weather?zip=84062&exclude={part}&appid=01151e6e9f5d5654cbc0915fcb06076e';
...
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    if(t <= 50 && s > 3) {
        const v = Math.pow(s, 0.16)
        const windchill = 35.74 + 0.6215 * t - 35.75 * v + 0.4275 * t * v;
